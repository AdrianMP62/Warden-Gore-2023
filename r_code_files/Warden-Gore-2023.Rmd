...
pacman::p_load("plot3D","datawizard","scatterplot3d","plot3Drgl","gridExtra","vegan", "tidyr","ggplot2","openxlsx2", "rgl", "ggrepel", "dplyr", "plyr", "scales", "ggpubr", "stringr","simba","reshape2", "knitr", "zoo", "car","reshape2","readxl","lubridate","Rcpp")
```
...
#convert CommonName and Survey to factors with defined order
Warden.spr.splots.agg$CommonName <- factor(Warden.spr.splots.agg$CommonName, levels = c("Darter", "Common Greenshank", "Hoary-headed Grebe", "Eurasian Coot", "Silver Gull", "Red-capped Plover", "Little Black Cormorant", "Hooded Plover"))
...
Warden.spr.splots
>>>>>>> 9e2b300e8953c0edec1cc148160d64f54fbc990d
...
p <- ggplot(subset(Warden.spr.splots, CommonName %in% "Australian Shelduck"), aes(x=reorder(Survey, SurvOrd), y=Count)) + geom_col()
p
